        ...
        <form>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <p>
                        <br />
                        <button type="submit" class="btn btn-primary" id="btnAmountConvert">Convert</button>
                        <button type="button" class="btn btn-info" id="btnAmountConvertAjax" ClientIdMode="Static">Convert by Ajax</button>
                    </p>
                </div>
                <div class="form-group">
